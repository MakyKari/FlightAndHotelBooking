...
public class MyApplication {
    ...
    public MyApplication(ClientController clientController, PilotController pilotController, FlightController flightController, HotelController hotelController) {
