...
public class ClientRepository implements IClientRepository {
    ...
    public Client findClient(String telephoneNumber, String password) {
        ...
        try {
            con = db.getConnection();
            String sql = "select id,firstname, secondname, telephonenumber, age, password, isadmin " + "from clients " + "where telephonenumber = ?";
            PreparedStatement preparedStmt = con.prepareStatement(sql);
            ...
            while (rs.next()) {
                ...
                return new Client(rs.getString("firstname"), rs.getString("secondname"),
                        rs.getInt("age"), rs.getString("telephonenumber"), rs.getString("password"), rs.getBoolean("isadmin"));
            }
        } catch (Exception e) {
            System.out.println(e + "Connection Error!");
        }
